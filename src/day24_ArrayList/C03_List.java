...
public class C03_List {
	...
	public static void main(String[] args) {
		...
		System.out.println("list olarak: " + gecici); // List olarak istenmeyen eleman haric tum elemanlari yazdi
		// sonucu array olarak istiyorsak, listedekileri yeni array'e ekleyebiliriz
		
		int yeniArray[] = new int[gecici.size()];
		
		// listedeki elemanlari indekle alabilir miyiz: 
		
		for(int i=0; i<yeniArray.length; i++) 
		{
			yeniArray[i] = gecici.get(i);
		}
		// yeni arrayimizi yazdiralim
